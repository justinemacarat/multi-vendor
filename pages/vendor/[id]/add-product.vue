<template>
  <div class="max-w-md mx-auto p-4">
    ...
    <NuxtLink :to="`/vendor/${route.params.id}`" class="mt-4 inline-block text-blue-500 hover:underline">Back to Dashboard</NuxtLink>
  </div>
</template>
...
const addProduct = () => {
  ...
  resetFields()
  router.push(`/vendor/${route.params.id}`) // Redirect to the vendor dashboard with the specific ID
}
